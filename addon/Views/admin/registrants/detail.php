  ...
  <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-5">
    <div class="space-y-1">
      <div class="flex items-center gap-2">
        <a data-spa href="<?= getBaseUrl('/admin/registrants') ?>" class="text-xs font-bold text-indigo-650 hover:text-indigo-700 flex items-center gap-1 transition-colors">
    ...
    <div class="flex flex-wrap items-center gap-2">
      <a href="<?= getBaseUrl('/admin/registrants/pdf/formulir?id=' . $registration['id']) ?>" class="inline-flex items-center justify-center px-4 py-2 bg-white hover:bg-slate-50 text-slate-700 font-bold rounded-xl border border-slate-200 shadow-sm text-xs transition-colors">
        📄 Cetak Formulir
      </a>
      <a data-spa href="<?= getBaseUrl('/admin/registrants/edit?id=' . $registration['id']) ?>" class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-sm text-xs transition-colors cursor-pointer">
        ✏️ Koreksi Data
      </a>
    </div>
  </div>
              ...
              <?php else: foreach ($documents as $doc): ?>
                <div class="flex justify-between items-center py-2 border-b border-slate-50 last:border-0 font-medium text-slate-700">
                  ...
                  <div class="flex items-center gap-1.5">
                    <a href="<?= getBaseUrl('/documents/view?id=' . $doc['id']) ?>" target="_blank" class="inline-flex items-center justify-center p-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg transition-colors cursor-pointer text-[10px] font-bold">
                      👁️ Lihat
                    </a>
                  </div>
                </div>
