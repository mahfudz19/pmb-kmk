  ...
  <div class="relative bg-white rounded-xl p-6 max-w-md w-full shadow-2xl border border-slate-100 space-y-4 transform scale-95 opacity-0 transition-all duration-200" id="reject-modal-card">
    ...
    <form action="<?= getBaseUrl('/admin/verifications/verify-document') ?>" method="POST" class="space-y-4 text-xs">
      ...
      <div class="flex justify-end gap-2 pt-2 border-t border-slate-100">
        ...
        <button type="submit" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-bold rounded-full transition-colors cursor-pointer shadow-sm">Tolak Dokumen</button>
      </div>
    </form>
  </div>
</div>
