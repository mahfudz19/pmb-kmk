...
<div class="w-full py-2 space-y-8">
  <?php if (!$selectedWave): ?>
    <div class="bg-white rounded-3xl shadow-sm border border-slate-200/80 p-8 max-w-md mx-auto text-center space-y-6">
      ...
      <div class="pt-2">
        <a href="/dashboard" class="inline-flex px-6 py-3 bg-indigo-600 text-white rounded-xl text-xs font-bold hover:bg-indigo-750 transition-all shadow-sm">Pilih Gelombang</a>
      </div>
    </div>
  <?php else: ?>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-200/80 overflow-hidden p-6 md:p-8">
      ...
      <div id="step-content-3" class="step-pane space-y-6 hidden">
        ...
        <div class="bg-amber-50 border border-amber-250 p-5 rounded-2xl space-y-3">
          ...
          <p class="text-xs text-amber-900 leading-relaxed font-semibold">Sebelum mengunci pendaftaran, pastikan Anda telah melengkapi seluruh data profil Anda di halaman <a href="/profile" target="_blank" class="text-indigo-650 hover:underline"><strong>Profil Saya</strong></a> (termasuk Alamat Lengkap, Data Orang Tua/Wali, Kebutuhan Khusus, dan Riwayat Pendidikan). Data profil yang tidak lengkap dapat menyebabkan pendaftaran Anda ditolak.</p>
